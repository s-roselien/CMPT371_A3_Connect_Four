...
* **Code Origin:** 
The socket boilerplate and server structure was adapted from the course sample repo. The Connect Four game logic, protocol design, and threading model were written by the group.
